    ...
    return [
      ...
      ...billerKeys.map((biller) => {
        ...
        return {
          value: biller,
          label: (
            <BillerTabLabel label={label} rows={byBiller.get(biller) ?? []} />
          ),
          selectLabel: label,
          ariaLabel: `Filter to ${providerDisplayName(biller)}`,
        };
      }),
    ];
                        ...
                        return (
                          ...
                          >
                            <button
                              ...
                              aria-expanded={
                                hasBreakdown ? isExpanded : undefined
                              }
                            >
                ...
                <div className="space-y-4">
                  <Card>
                    <CardHeader className="px-5 pt-5 pb-2">
                      ...
                      <CardDescription>
                        Run costs attributed through project-linked tasks.
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-2 px-5 pb-5 pt-2">
